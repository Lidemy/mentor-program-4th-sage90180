...
$id = $_GET['id'];
$sql = "SELECT content FROM sage_comments WHERE id =".$id;
$messsage = $conn->query($sql)->fetch_assoc()['content'];
      ...
      <div class="card_commens">
        ...
        <div class="card_body">
          <form method="POST" action="./handle_update.php">
            ...
            <div class="nickname">暱稱：<input name="nickname" class="nickname" type="text" value="<?php echo $nickname ?>">
              <?php
            ...
            <textarea class="text_area" name="content" placeholder="你說我在聽..." rows="10"><?php echo $messsage ?></textarea>
...
<script>
  document.querySelector('.fa-user-plus').addEventListener('click', () => {
